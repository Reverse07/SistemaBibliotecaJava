    ...
    private void initComponents2() {
        ...
        for (String opcion : opciones) {
            switch (opcion) {
                ...
                case "Devoluciones" -> jPanelContenido.add(new InterDevolucion(),opcion);
                case "Usuarios" -> jPanelContenido.add(new InterUsuario(), opcion);
                 case "Libros" -> jPanelContenido.add(new InterLibros(), opcion);
                default ->
   ...
   private JPanel crearTarjetaAnimada(String icono, String titulo, int valorFinal, Color colorTexto) {
    ...
    tarjeta.addMouseListener(new MouseAdapter() {
        ...
        public void mouseEntered(MouseEvent e) {
            if (timerAbajo != null && timerAbajo.isRunning()) timerAbajo.stop();
        ...
        public void mouseExited(MouseEvent e) {
            if (timerArriba != null && timerArriba.isRunning()) timerArriba.stop();
